...
print(f"@DEBUG:: C_INCLUDE_PATH: {C_INCLUDE_PATH}")
...
def cli():
    ...
    parser.add_argument(
        "--output_dir", "-o", type=str, default="", help="directory to save the outputs"
    )
    parser.add_argument(
        "--llm_model",
        "-m",
    ...
    parser.add_argument(
        ...
        "-p",
        type=str,
        default="Could you summarize the top insights from the conversation in bullet points?",
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="use google doc to save the outputs",
    )
    parser.add_argument(
        "--googledocname",
        "-n",
    ...
    if googledoc:
        googledoc_metadata = {"name": googledocname, "folder": googledocfolder}
